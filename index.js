...
submitButton.addEventListener('click', () => {
	let wrapper = document.querySelector('.mcc')
	let chosenCity = wrapper.querySelectorAll('span')[0]
	let totalPrice = wrapper.querySelectorAll('span')[1]
	chosenCity.innerText = city.value
